...
final class CodeRetrievalPlanValidator {
    ...
    private String fingerprint(RagPipelineService.CodeSearchOperation operation) {
        return CodeRagService.retrievalOperationKey(operation);
    }
    ...
    record PlanValidationError(PlanValidationCode code, String operationId, String detail) {
    }
