...
$environmentPath = Resolve-WorkspacePath $EnvironmentFile ".env.lan-http" $repoRoot
$policyPath = Resolve-WorkspacePath $NginxPolicyFile "deploy\lan-http.generated.inc" $repoRoot
...
$environmentContent = @"
# Generated by Initialize-LanHttp.ps1. Do not commit this server-specific file.
...
[ordered]@{
    schema = "learnbot.lan-http-initialization.v1"
