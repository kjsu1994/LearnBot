...
assert.deepEqual(view.timelines[0].eventLines, [
  ...
  '20 STOP_OUTCOME_RECORDED / COMPLETE_OR_PAUSE / approval false / may mutate false / enabled true / status RECORDED / final result false / stop TIMEOUT / outcome REPORT_TIMEOUT',
  '21 STOP_OUTCOME_RECORDED / COMPLETE_OR_PAUSE / approval false / may mutate false / enabled true / status RECORDED / final result false / stop CANCELLATION / outcome REPORT_CANCELLATION',
]);
